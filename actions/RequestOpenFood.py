...
class RequestOpenFood:
    ...
    def check_data(res):
        ...
        Extrat product(s) from ElasticSearch DSL.
        Output is an array of product(s)
        """
    ...
    def search_name(id_from=0, id_size=5, name=''):
        """
        Look for specific name along products.
        Will return n = id_size product containing the name.
        ...
        # Rend request
        r = requests.post(RequestOpenFood.URL_SEARCH, json=query,
                          headers=RequestOpenFood.HEADERS)
    ...
    def search_ingredient(id_from=0, id_size=5, name=''):
        """
        Look for specific ingredient along products.
        Will return n = id_size product containing the ingredient.
        id_from is used to skip values
        """
        # Look for specific term
        query = {
    ...
    def get_nutrient(name):
        ...
        """
        # Rend request
        res = requests.get(RequestOpenFood.URL_NUTRIENT, params={},
                           headers=RequestOpenFood.HEADERS)
