...
def make_store_location_webhook_result(req):
    data = get_store_info(req)
    ...
    image_url = 'http://icons.iconarchive.com/icons/'\
                'paomedia/small-n-flat/1024/shop-icon.png'

    speech = 'There are ' + str(stores_quantity) + ' ' + \
             data['store'] + ' in the city of ' + data['city'] + '!'
...
def get_store(store, lat, lng):
    ...
    #                'viewport': {
    #                    'southwest': {
    #                        'lng': 7.151085519708498,
    #                        'lat': 46.7984617697085
    #                    },
    #                    'northeast': {
    #                        'lng': 7.153783480291502,
    #                        'lat': 46.8011597302915
    #                    }
    #                }
    #            },
    ...
    #            'icon': 'https://maps.gstatic.com/.../restaurant-71.png'
    #        }
    #    ],
    #    'status': 'OK'
    # }
